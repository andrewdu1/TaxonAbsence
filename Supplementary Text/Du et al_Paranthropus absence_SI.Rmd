...
This should make sense, since this is the alternative interpretation we originally provided for $\psi$: the proportion of sites in which *Paranthropus* was present.
...
We included the median because our parameters are bounded ($\psi$ is bounded by 0 and 1, and $\lambda$ is bounded by $-\infty$ and 0), so their sampling distributions are likely to be skewed as the prespecified values approach these bounds.
